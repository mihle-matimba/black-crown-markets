...
function bindLogoutRedirect(){var yesBtn=document.querySelector('#mb-signout .button-yes');if(!yesBtn||yesBtn.dataset.bcmLogout)return;yesBtn.dataset.bcmLogout='1';yesBtn.addEventListener('click',function(e){e.preventDefault();var href=yesBtn.getAttribute('href');function redirect(){window.location.href='https://register.blackcrownmarkets.com';}fetch(href,{mode:'no-cors',credentials:'include'}).then(redirect,redirect);});}
