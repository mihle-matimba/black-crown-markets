(function(){function buildSidebar(){var sidebar=document.querySelector('.page-sidebar');if(!sidebar)return;var nav=document.querySelector('#navigationBlock');if(!nav)return;var trades=document.querySelector('#tradingHistoryMenu');var settings=document.querySelector('#accountSettingsMenu');var platforms=document.querySelector('#tradingPlatformsMenu');
...
var topGroup=document.createElement('ul');topGroup.className='x-navigation';topGroup.style.cssText='list-style:none;padding:0;margin:0;';topGroup.insertAdjacentHTML('beforeend','<li><a href="/"><span class="xn-text">My Account</span></a></li>');topGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/deposit"><span class="xn-text">Fund Account</span></a></li>');topGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/transactions"><span class="xn-text">Transactions</span></a></li>');if(trades){var tradeText=trades.querySelector('.xn-text');if(tradeText)tradeText.textContent='Trades';topGroup.appendChild(trades);}
newNav.appendChild(topGroup);newNav.insertAdjacentHTML('beforeend','<div class="bcm-divider"></div>');
newNav.insertAdjacentHTML('beforeend','<div class="bcm-group-label"><span class="fa fa-files-o"></span>ACCOUNT SETTINGS<span class="fa fa-chevron-down bcm-chevron"></span></div>');var settingsGroup=document.createElement('ul');settingsGroup.className='x-navigation';settingsGroup.style.cssText='list-style:none;padding:0;margin:0;';settingsGroup.insertAdjacentHTML('beforeend','<li><a href="/accounts"><span class="xn-text">Trading Accounts</span></a></li>');if(settings){var settingsSubItems=settings.querySelectorAll(':scope > ul > li');settingsSubItems.forEach(function(li){settingsGroup.appendChild(li);});}
newNav.appendChild(settingsGroup);newNav.insertAdjacentHTML('beforeend','<div class="bcm-divider"></div>');
newNav.insertAdjacentHTML('beforeend','<div class="bcm-group-label"><span class="fa fa-exchange"></span>REQUESTS<span class="fa fa-chevron-down bcm-chevron"></span></div>');var requestsGroup=document.createElement('ul');requestsGroup.className='x-navigation';requestsGroup.style.cssText='list-style:none;padding:0;margin:0;';requestsGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/request-status"><span class="xn-text">Request Status</span></a></li>');requestsGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/withdraw"><span class="xn-text">Withdrawal</span></a></li>');requestsGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/internal-transfers"><span class="xn-text">Internal Transfer</span></a></li>');requestsGroup.insertAdjacentHTML('beforeend','<li><a href="https://register.blackcrownmarkets.com/change-leverage"><span class="xn-text">Change Leverage</span></a></li>');
newNav.appendChild(requestsGroup);newNav.insertAdjacentHTML('beforeend','<div class="bcm-divider"></div>');
newNav.insertAdjacentHTML('beforeend','<div class="bcm-group-label"><span class="fa fa-download"></span>TRADING PLATFORMS<span class="fa fa-chevron-down bcm-chevron"></span></div>');var platformsGroup=document.createElement('ul');platformsGroup.className='x-navigation';platformsGroup.style.cssText='list-style:none;padding:0;margin:0;';if(platforms){var platformSubItems=platforms.querySelectorAll(':scope > ul > li');platformSubItems.forEach(function(li){platformsGroup.appendChild(li);});}
platformsGroup.insertAdjacentHTML('beforeend','<li><a href="https://webtrader.blackcrownmarkets.com"><span class="xn-text">WebTrader</span></a></li>');newNav.appendChild(platformsGroup);
...
function showDepositConfirmModal(){if(document.querySelector('.bcm-modal-overlay'))return;var overlay=document.createElement('div');overlay.className='bcm-modal-overlay';overlay.innerHTML='<div class="bcm-modal"><p class="bcm-modal-text">Please allow time for funds to leave your crypto wallet and reflect in your trading account.<span class="bcm-modal-line2">If it takes longer, please <a href="mailto:support@blackcrownmarkets.com" class="bcm-modal-link">contact support</a>.</span></p><a href="https://register.blackcrownmarkets.com/" class="bcm-modal-btn">Back to Dashboard</a></div>';document.body.appendChild(overlay);}
...
var overlay=document.createElement('div');overlay.className='bcm-modal-overlay';overlay.innerHTML='<div class="bcm-modal"><button type="button" class="bcm-modal-close" aria-label="Close">&times;</button><p class="bcm-modal-text">You don\'t have a trading account yet.<span class="bcm-modal-line2">Open a live or demo account to start trading with Black Crown Markets.</span></p><a href="https://register.blackcrownmarkets.com/accounts" class="bcm-modal-btn">Open an Account</a></div>';document.body.appendChild(overlay);
...
if(currentStep===1){window.location.href='https://register.blackcrownmarkets.com/';return;}
