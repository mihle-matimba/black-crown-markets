...
function buildNoAccountModal(){var mainContent=document.querySelector('.page-content-wrap');if(!mainContent)return;var select=document.querySelector('#selectAccounts');if(select&&select.options.length>0)return;if(document.querySelector('.bcm-modal-overlay'))return;try{if(sessionStorage.getItem('bcmNoAccountModalShown'))return;sessionStorage.setItem('bcmNoAccountModalShown','1');}catch(e){}
