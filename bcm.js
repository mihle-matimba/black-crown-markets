...
infoTitles.forEach(function(titleEl){if(titleEl.textContent.trim()==='Important Information'){var infoPanel=titleEl.closest('.panel');if(infoPanel)infoPanel.remove();}});
}
